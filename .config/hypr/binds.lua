...
hl.bind("SUPER + P", hl.dsp.exec_cmd("~/.config/hypr/scripts/hyprshot.sh"))

-- WF-RECORDER
hl.bind("SUPER + CONTROL + R", hl.dsp.exec_cmd("~/.config/hypr/scripts/wf-recorder/region.sh"))
hl.bind("SUPER + SHIFT + R", hl.dsp.exec_cmd("~/.config/hypr/scripts/wf-recorder/window.sh"))
hl.bind("SUPER + R", hl.dsp.exec_cmd("~/.config/hypr/scripts/wf-recorder/monitor.sh"))
